            ...
            for distance, original_idx, nbr_id in valid_neighbors[:max_neighbors]:
                ...
                if max_edge == 4:
                    ...
                    if nbr_key in node_lookup:
                        nbr_bbox = node_lookup[nbr_key]["position"]
                        _bbox = [nbr_bbox[0], nbr_bbox[1], nbr_bbox[2]]
...
if __name__ == "__main__":
    ...
    base_dir = "/home/lee/research/Research2025/YOLOv11/2_categorized_vehicle_data"
    ...
    output_folder_name = "4_world_graph_data"
